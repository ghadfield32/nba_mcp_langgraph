...
def save_documentation(api_docs: dict, output_dir: str = "api_documentation"):
    ...
    (output_path / "endpoints.json").write_text(json.dumps(api_docs["endpoints"], indent=2), encoding="utf-8")
    (output_path / "static_data.json").write_text(json.dumps(api_docs["static_data"], indent=2), encoding="utf-8")
