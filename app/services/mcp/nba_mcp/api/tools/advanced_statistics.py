...
def get_player_season_advanced(
    player: str | int, season: str, start_date: str | None = None, end_date: str | None = None
) -> pd.DataFrame:
    """
    ...
    finder = leaguegamefinder.LeagueGameFinder(
        player_or_team_abbreviation="P", player_id_nullable=pid, season_nullable=season_fmt
    )
